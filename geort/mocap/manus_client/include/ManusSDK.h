...
#error Unrecognized platform.
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_FunctionCalledAtWrongTime if the function was not intended to be called at this time
    /// SDKReturnCode_ArgumentSizeMismatch if p_NumberOfHostsThatFitInArray does not match the number of available hosts
    /// found in the network, SDKReturnCode_InvalidArgument if the provided p_AvailableHostsFound is a null pointer,
    /// SDKReturnCode_InternalError if the number of available hosts found is higher than the defined MAX_NUMBER_OF_HOSTS,
    /// SDKReturnCode_UnsupportedStringSizeEncountered if the name of a host is higher than the defined
    /// MAX_NUM_CHARS_IN_HOST_NAME, SDKReturnCode_Error if copying the string representing the host name was not successful,
    ...
    /// SDKReturnCode_FunctionCalledAtWrongTime if the function was not intended to be called at this time,
    /// SDKReturnCode_NoCoordinateSystemSet if the user tried to connect without first setting up the coordinate system
    /// settings.
    ...
    /// @return SDKReturnCode_Success if successful,
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available.
    CORESDK_API SDKReturnCode
    CoreSdk_RegisterCallbackForLandscapeStream(LandscapeStreamCallback_t p_LandscapeStreamCallback);
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available.
    CORESDK_API SDKReturnCode
    CoreSdk_RegisterCallbackForErgonomicsStream(ErgonomicsStreamCallback_t p_ErgonomicsStreamCallback);
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available.
    CORESDK_API SDKReturnCode
    CoreSdk_RegisterCallbackForRawSkeletonStream(RawSkeletonStreamCallback_t p_RawSkeletonStreamCallback);
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core.
    CORESDK_API SDKReturnCode CoreSdk_VibrateFingersForSkeleton(uint32_t p_SkeletonId, Side p_HandType,
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_ArgumentSizeMismatch if p_NumberOfIdsThatFitInArray does not match with the number of available gloves
    /// found, SDKReturnCode_InvalidArgument if p_NumberOfIdsThatFitInArray is zero or is higher than the defined
    /// MAX_NUMBER_OF_GLOVES.
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core.
    CORESDK_API SDKReturnCode CoreSdk_GetGlovesForDongle(uint32_t p_DongleId, uint32_t *p_LeftGloveId,
    ...
    /// SDKReturnCode_InvalidArgument if p_NumberOfIdsThatFitInArray is zero or higher than the defined
    /// MAX_NUMBER_OF_HAPTICS_DONGLES.
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_InternalError if the number of haptic dongles found is higher than the defined
    /// MAX_NUMBER_OF_HAPTICS_DONGLES.
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_ArgumentSizeMismatch if p_NumberOfIdsThatFitInArray does not match with the number of haptic dongles
    /// found, SDKReturnCode_InvalidArgument if p_NumberOfIdsThatFitInArray is zero or higher than the defined
    /// MAX_NUMBER_OF_HAPTICS_DONGLES.
    ...
    /// Note that this is reliant on the landscape, and the first second after connecting the client to the core it will not
    /// yet have landscape data, so the number of users wil be 0. Since there will always be a default users, just wait until
    /// the count is above 0 and then proceed.
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_InvalidArgument if p_NumberOfIdsThatFitInArray is null or higher than the defined MAX_NUMBER_OF_USERS,
    /// or if p_IdsOfAvailableUsers is a null array. SDKReturnCode_ArgumentSizeMismatch if p_NumberOfIdsThatFitInArray does
    /// not match with number of available users found.
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_ArgumentSizeMismatch if p_TrackerIndex is higher than the total number of trackers received from the
    /// tracker stream.
    ...
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_InvalidArgument if p_NumberOfIdsThatFitInArray is zero or higher than the defined
    /// MAX_NUMBER_OF_TRACKERS, or if p_IdsOfAvailableTrackers is a null array. SDKReturnCode_ArgumentSizeMismatch if
    /// p_NumberOfIdsThatFitInArray does not match with the number of available trackers found.
    ...
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_InternalError if the number of trackers found is higher than the defined MAX_NUMBER_OF_TRACKERS.
    CORESDK_API SDKReturnCode CoreSdk_GetNumberOfAvailableTrackersForUserIndex(uint32_t *p_NumberOfAvailableTrackers,
    ...
    /// MAX_NUMBER_OF_TRACKERS, or if p_IdsOfAvailableTrackers is a null array. SDKReturnCode_ArgumentSizeMismatch if
    /// p_NumberOfIdsThatFitInArray does not match with the number of available trackers found.
    CORESDK_API SDKReturnCode CoreSdk_GetIdsOfAvailableTrackersForUserIndex(TrackerId *p_IdsOfAvailableTrackers,
                                                                            uint32_t p_UserIndex,
                                                                            uint32_t p_NumberOfIdsThatFitInArray);
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_DataNotAvailable if no tracker with the given p_TrackerId and the given p_TrackerType was found in the
    /// landscape.
    CORESDK_API SDKReturnCode CoreSdk_GetDataForTracker_UsingIdAndType(uint32_t p_UserId, uint32_t p_TrackerType,
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_StubNullPointer if the stub has been reset but someone is trying to use it anyway. This usually happens
    /// after a shutdown of the SDK, SDKReturnCode_NullPointer if the provided p_TrackerData is a null pointer,
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_ArgumentSizeMismatch if p_ArraySize is higher than the total number of gestures in the landscape
    /// stream.
    CORESDK_API SDKReturnCode CoreSdk_GetGestureLandscapeData(GestureLandscapeData *p_LandscapeDataArray,
    ...
    /// SDKReturnCode_ArgumentSizeMismatch if p_ArraySize is higher than the total number of gestures in the landscape
    /// stream.
    CORESDK_API SDKReturnCode CoreSdk_GetGestureStreamData(uint32_t p_GestureStreamDataIndex, uint32_t p_StartDataIndex,
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_ArgumentSizeMismatch if p_SkeletonIndex is higher than the total number of skeletons received from the
    /// skeleton stream.
    ...
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_ArgumentSizeMismatch if p_SkeletonIndex is higher than the total number of skeletons received from the
    /// skeleton stream or if the provided p_NodeCount is different from the node count of that skeleton.
    ...
    /// SDKReturnCode_ArgumentSizeMismatch if p_SkeletonIndex is higher than the total number of skeletons received from the
    /// skeleton stream or if the provided p_NodeCount is different from the node count of that skeleton.
    CORESDK_API SDKReturnCode CoreSdk_GetRawSkeletonData(uint32_t p_SkeletonIndex, SkeletonNode *p_Nodes,
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_DataNotAvailable if the requested glove is not found or if the skeleton does not have any user
    /// associated to it, SDKReturnCode_InvalidArgument if the provided p_HandType is neither Left nor Right.
    CORESDK_API SDKReturnCode CoreSdk_DoesSkeletonGloveSupportHaptics(uint32_t p_SkeletonId, Side p_HandType,
                                                                      bool *p_IsHaptics);
    /******************************************************************************
    ...
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any skeleton setup.
    CORESDK_API SDKReturnCode CoreSdk_AddMeshSetupToSkeletonSetup(uint32_t p_SkeletonSetupIndex, uint32_t p_NodeID,
    ...
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any skeleton setup.
    CORESDK_API SDKReturnCode CoreSdk_AddVertexToMeshSetup(uint32_t p_SkeletonSetupIndex, uint32_t p_MeshSetupIndex,
                                                           Vertex p_Vertex);
    ...
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any skeleton setup.
    CORESDK_API SDKReturnCode CoreSdk_AddTriangleToMeshSetup(uint32_t p_SkeletonSetupIndex, uint32_t p_MeshSetupIndex,
                                                             Triangle p_Triangle);
    ...
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any skeleton setup,
    /// SDKReturnCode_NullPointer if the skeleton setup was not correctly saved, thus the new skeleton setup is a null
    /// pointer.
    ...
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_StubNullPointer if the stub has been reset but someone is trying to use it anyway. This usually happens
    /// after a shutdown of the SDK, SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any
    /// skeleton setup.
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_NullPointer if the provided p_SDK (used to store the setup chains) is a null pointer, it should be
    /// initialized to an array with size equal to the chains count, SDKReturnCode_InvalidID if the provided
    /// p_SkeletonSetupIndex does not correspond to any skeleton setup.
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_NullPointer if the provided p_SDK (used to store the setup nodes) is a null pointer, it should be
    /// initialized to an array with size equal to the nodes count, SDKReturnCode_InvalidID if the provided
    /// p_SkeletonSetupIndex does not correspond to any skeleton setup.
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_NullPointer if the provided p_SDK (used to store the setup colliders) is a null pointer, it should be
    /// initialized to an array with size equal to the colliders count, SDKReturnCode_InvalidID if the provided
    /// p_SkeletonSetupIndex does not correspond to any skeleton setup.
    ...
    /// Returns the skeleton ID of the loaded skeleton, this ID is used to identify the skeleton in the
    /// SkeletonStreamCallback. Loading a skeleton into core for retargetting removes it from the temporary skeletons array,
    /// thus causing the p_SkeletonSetupIndex to no longer be valid after this call.
    ...
    /// SDKReturnCode_SdkNotAvailable if the Core SDK is not available,
    /// SDKReturnCode_StubNullPointer if the stub has been reset but someone is trying to use it anyway. This usually happens
    /// after a shutdown of the SDK, SDKReturnCode_NotConnected if there is no connection to core.
    ...
    /// p_IsSkeletonModified is intended to be used mainly by the Dev Tools, it is set to true after saving any modification
    /// to the skeleton, this triggers the OnSyStemCallback which is used in the SDK to be notified about a change to its
    /// temporary skeletons.
    /// @param p_SkeletonSetupIndex
    /// @param p_SessionId
    ...
    /// after a shutdown of the SDK, SDKReturnCode_InvalidID if the provided p_SkeletonSetupIndex does not correspond to any
    /// skeleton setup.
    CORESDK_API SDKReturnCode CoreSdk_SaveTemporarySkeleton(uint32_t p_SkeletonSetupIndex, uint32_t p_SessionId,
                                                            bool p_IsSkeletonModified);

    /// @brief Send a temporary skeleton to Core to compress it (convert it into an array of bytes) and then get the
    /// compressed data back in the SDK, the skeleton compressed data are stored internally. It returns the length of the
    /// bytes array for correct memory allocation. This function must be called before
    ...
    /// @brief Get the compressed temporary skeleton data which are stored internally when calling function
    /// CoreSdk_CompressTemporarySkeletonAndGetSize. The size of p_TemporarySkeletonData must match with
    ...
    /// SDKReturnCode_NotConnected if there is no connection to core,
    /// SDKReturnCode_StubNullPointer if the stub has been reset but someone is trying to use it anyway. This usually happens
    /// after a shutdown of the SDK,
    CORESDK_API SDKReturnCode CoreSdk_GetTemporarySkeleton(uint32_t p_SkeletonSetupIndex, uint32_t p_SessionId);

    /// @brief Send the compressed data (an array of bytes) retrieved from a file to Core to be decompressed and converted
    /// back into a temporary skeleton. The received temporary skeleton is saved internally with the given index and to the
    /// given session id. The size of p_TemporarySkeletonData must match with p_TemporarySkeletonLengthInBytes.
    /// @param p_SkeletonSetupIndex
    /// @param p_SessionId
    /// @param p_PathName
    /// @return SDKReturnCode_Success if successful,
