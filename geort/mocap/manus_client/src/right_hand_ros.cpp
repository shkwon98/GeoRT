...
ClientReturnCode SDKMinimalClient::InitializeSDK()
{
    ...
    t_VUH.handedness = Side::Side_Right; // this is currently set to unreal mode.
            ...
            if (m_Skeleton != nullptr && m_Skeleton->skeletons.size() != 0)
            {
                ...
                for (const auto &skeleton : m_Skeleton->skeletons)
                {
                    ...
                    for (int i = 0; i < skeleton.info.nodesCount; i++)
                    {
                        ...
                        std::cout << "Position: (" << node.transform.position.x << ", " << node.transform.position.y << ", "
                                  << node.transform.position.z << ")" << std::endl;
...
bool SDKMinimalClient::SetupHandNodes(uint32_t p_SklIndex)
{
    ...
    ManusVec3 t_Fingers[t_NumFingers * t_NumJoints] = {
        CreateManusVec3(0.0250f, 0.0000f, 0.0050f),  CreateManusVec3(0.0000f, 0.0000f, 0.0390f),
        CreateManusVec3(0.0000f, 0.0000f, 0.0330f),  CreateManusVec3(0.0000f, 0.0000f, 0.0210f),
        CreateManusVec3(0.0170f, 0.0000f, 0.0870f),  CreateManusVec3(0.0000f, 0.0000f, 0.0260f),
        CreateManusVec3(0.0000f, 0.0000f, 0.0220f),  CreateManusVec3(0.0000f, 0.0000f, 0.0220f),
        CreateManusVec3(0.0000f, 0.0000f, 0.0920f),  CreateManusVec3(0.0000f, 0.0000f, 0.0260f),
        CreateManusVec3(0.0000f, 0.0000f, 0.0260f),  CreateManusVec3(0.0000f, 0.0000f, 0.0220f),
        CreateManusVec3(-0.0170f, 0.0000f, 0.0840f), CreateManusVec3(0.0000f, 0.0000f, 0.0210f),
        CreateManusVec3(0.0000f, 0.0000f, 0.0210f),  CreateManusVec3(0.0000f, 0.0000f, 0.0200f),
        CreateManusVec3(-0.0340f, 0.0000f, 0.0720f), CreateManusVec3(0.0000f, 0.0000f, 0.0210f),
        CreateManusVec3(0.0000f, 0.0000f, 0.0210f),  CreateManusVec3(0.0000f, 0.0000f, 0.0200f),
        ...
        // CreateManusVec3(0.011181f, 0.000000f, 0.052904f), //Index MCP joint, if metacarpal is present:
        // CreateManusVec3(0.000000f, 0.000000f, 0.052904f) CreateManusVec3(0.000000f, 0.000000f, 0.038257f), //Index PIP
        // joint CreateManusVec3(0.000000f, 0.000000f, 0.020884f), //Index DIP joint CreateManusVec3(0.000000f, 0.000000f,
        // 0.018759f), //Index Tip joint
        ...
        // CreateManusVec3(-0.011274f, 0.000000f, 0.049802f),  //Ring MCP joint, if metacarpal is present:
        // CreateManusVec3(0.000000f, 0.000000f, 0.049802f), CreateManusVec3(0.000000f, 0.000000f, 0.039736f),  //Ring PIP
        // joint CreateManusVec3(0.000000f, 0.000000f, 0.023564f),  //Ring DIP joint CreateManusVec3(0.000000f, 0.000000f,
        // 0.019868f),  //Ring Tip joint

        // //CreateManusVec3(-0.020145f, 0.027538f, 0.000000f), //Pinky CMC joint
        // CreateManusVec3(-0.020145f, 0.000000f, 0.047309f),  //Pinky MCP joint, if metacarpal is present:
        // CreateManusVec3(0.000000f, 0.000000f, 0.047309f), CreateManusVec3(0.000000f, 0.000000f, 0.033175f),  //Pinky PIP
        // joint CreateManusVec3(0.000000f, 0.000000f, 0.018020f),  //Pinky DIP joint CreateManusVec3(0.000000f, 0.000000f,
        // 0.019129f),  //Pinky Tip joint
    };
    ...
    //
    // root, This node has ID 0 and  ID 0, to indicate it has no parent.
